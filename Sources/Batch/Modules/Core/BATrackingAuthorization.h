...
typedef NS_ENUM(NSUInteger, BATrackingAuthorizationStatus) {
    ...
    // User agreed to tracking. On iOS 13 and lower this is the default value, but on iOS 14 this is only used when the
    // user explicitly allowed tracking via AppTrackingTransparency
