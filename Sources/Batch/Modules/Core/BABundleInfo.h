...
If it is found in the main bundle info plist under the key "BATCH_APP_GROUP_ID" and not empty, this value will be returned
Otherwise, it will be "group.{bundle_id}.batch
*/
