...
- (void)startNewSession
{
    if (_activeSession)
    {
        [BALogger debugForDomain:@"SessionManager" message:@"Refusing to start a new session, since no backgrounding was detected"];
        [BALogger debugForDomain:@"SessionManager" message:@"This can happen in some situations (such as app first launch). Previous uptime %f, actual %f", _lastBackgroundUptime, [BAUptimeProvider uptime]];
        return;
    }
