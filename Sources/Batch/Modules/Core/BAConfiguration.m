...
- (NSError *)setDevelopperKey:(NSString *)key
{
    ...
    {
        return [[NSError alloc] initWithDomain:ERROR_DOMAIN code:BAInternalFailReasonInvalidAPIKey userInfo:@{NSLocalizedDescriptionKey: @"Empty or void developper key."}];
    }
