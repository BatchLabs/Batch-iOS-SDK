...
/*!
 ...
 @discussion This object is responsible for finding the right events to send, send them when asked, and handle their state.
 */
...
/*!
 ...
 @return YES if the webservice has been started by calling this method or the webservice was already running, NO if no events were available to send or sending is disabled.
 */
