...
- (instancetype)initWithIdentifier:(NSString *)identifier name:(NSString *)name date:(NSString *)date parameters:(NSString *)parameters state:(BAEventState)state session:(NSString*)session andTick:(long long)tick
{
...
- (instancetype)initWithIdentifier:(NSString *)identifier name:(NSString *)name date:(NSString *)date secureDate:(NSString *)secureDate parameters:(NSString *)parameters state:(BAEventState)state session:(NSString*)session andTick:(long long)tick
{
    self = [self initWithIdentifier:identifier name:name date:date parameters:parameters state:state session:session andTick:tick];
    if ([BANullHelper isNull:self])
    {
        return self;
    }
...
+ (instancetype)eventWithIdentifier:(NSString *)identifier name:(NSString *)name date:(NSString *)date parameters:(NSString *)parameters state:(BAEventState)state session:(NSString*)session andTick:(long long)tick
{
    return [[BAEvent alloc] initWithIdentifier:identifier name:name date:date parameters:parameters state:state session:session andTick:tick];
}

+ (instancetype)eventWithIdentifier:(NSString *)identifier name:(NSString *)name date:(NSString *)date secureDate:(NSString *)secureDate parameters:(NSString *)parameters state:(BAEventState)state session:(NSString*)session andTick:(long long)tick
{
    return [[BAEvent alloc] initWithIdentifier:identifier name:name date:date secureDate:secureDate parameters:parameters state:state session:session andTick:tick];
}
...
+ (instancetype)eventWithIdentifier:(NSString *)identifier name:(NSString *)name date:(NSString *)date parameters:(NSString *)parameters state:(BAEventState)state session:(NSString*)session andTick:(long long)tick
{
    return [[BACollapsableEvent alloc] initWithIdentifier:identifier name:name date:date parameters:parameters state:state session:session andTick:tick];
}

+ (instancetype)eventWithIdentifier:(NSString *)identifier name:(NSString *)name date:(NSString *)date secureDate:(NSString *)secureDate parameters:(NSString *)parameters state:(BAEventState)state session:(NSString*)session andTick:(long long)tick
{
    return [[BACollapsableEvent alloc] initWithIdentifier:identifier name:name date:date secureDate:secureDate parameters:parameters state:state session:session andTick:tick];
}
