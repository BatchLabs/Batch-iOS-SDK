    ...
    if (files != nil) {
        ...
        for (NSURL *file in files) {
            ...
            if (data != nil) {
                ...
                if (receiptError != nil) {
                    [BALogger errorForDomain:LOGGER_DOMAIN message:@"Could not unpack/pack data from file, deleting invalid receipt: %@.", [receiptError localizedDescription]];
        ...
        BAWebserviceClient *wsClient = [[BADisplayReceiptWebserviceClient alloc]
                                        initWithReceipts:receipts
                                        success:^() {
