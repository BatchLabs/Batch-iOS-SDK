                                ...
                                attachToParentBottom:(BOOL)attachToParentBottom
{
    ...
    else
    {
        ...
        [constraints addObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:[NSString stringWithFormat:@"|-(>=%f@1000)-[target]-(>=%f@1000)-|", margin.left, -margin.right]
                                                                                 options:0
                                                                                 metrics:nil
    ...
    // Top margin
    NSLayoutConstraint *topMargin = [NSLayoutConstraint constraintWithItem:target
    ...
    else
    {
        ...
        // Use the separator view to support a bottom margin. Separator views don't support margin, so we can do that for them
