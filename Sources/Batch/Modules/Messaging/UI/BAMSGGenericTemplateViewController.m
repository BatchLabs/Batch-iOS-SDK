...
- (BAMSGStackViewItem*)labelStackViewItemForLabel:(NSString*)label withNodeIdentifier:(NSString*)nodeIdentifier previousView:(UIView*)previousView
{
        ...
        if ([sender isKindOfClass:[UIButton class]])
        {
            ...
            if (ctaID < [self.ctas count])
            {
                ...
                [BAThreading performBlockOnMainThreadAsync:^{
                    [BAMessagingCenter.instance messageButtonClicked:self.messageDescription ctaIndex:ctaID action:cta.actionIdentifier];
                    
                    // We don't need to handle BAMSGCTAActionKindClose since we did that earlier
                    [BAMessagingCenter.instance performAction:cta source:self.messageDescription.sourceMessage];
                }];
            }
            else
            {
