...
/// @param useSafeArea Use the safe area as inset, or constraint the view to it. true: constraint the child view to the safeAreaLayoutGuide, applying insets outside of the view
///                          false: the view will be exactly the same size as the parent is and should handle the safe area using insets
