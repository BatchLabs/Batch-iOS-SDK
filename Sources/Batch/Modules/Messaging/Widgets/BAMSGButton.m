...
- (void)updateCornerRadius
{
    ...
    if (_savedCornerRadius != nil) {
        ...
        self.layer.cornerRadius = MIN(self.bounds.size.height / 2, MIN(self.bounds.size.width / 2, _savedCornerRadius.doubleValue));
    }
...
- (void)applyRules:(nonnull BACSSRules*)rules
{
    ...
    UIFont *customFont = [BAMSGStylableViewHelper fontFromRules:rules baseFont:sBAMSGButtonFontOverride baseBoldFont:sBAMSGButtonBoldFontOverride];
    if (customFont)
    {
