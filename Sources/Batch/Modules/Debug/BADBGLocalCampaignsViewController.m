...
{
    if (section == 0) {
        return @"Note: If refreshing the campaigns succeeds, the campaign count might not be refreshed until this view is closed and reopened.";
    }
    return nil;
}
    ...
    switch (indexPath.section) {
        case 0:
            switch (indexPath.row) {
                case 0:
                    cell.textLabel.text = [NSString stringWithFormat:@"%lu campaign(s)",(unsigned long)BALocalCampaignsCenter.instance.campaignManager.campaignList.count];
