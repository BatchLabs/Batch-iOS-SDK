...
- (NSError*)registerAction:(nonnull BatchUserAction*)action
{
    ...
    if ([action.identifier stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]].length == 0)
    {
        return [NSError errorWithDomain:ACTIONS_ERROR_DOMAIN
                                   code:BatchActionErrorInvalidArgument
    ...
    if ([identifier hasPrefix:kBAActionsReservedIdentifierPrefix])
    {
        return [NSError errorWithDomain:ACTIONS_ERROR_DOMAIN
                                   code:BatchActionErrorInvalidArgument
                               userInfo:@{NSLocalizedDescriptionKey: [NSString stringWithFormat:@"The action's identifier cannot start with '%@'", kBAActionsReservedIdentifierPrefix]}];
    }
...
- (BOOL)performAction:(NSString*)identifier withArgs:(NSDictionary<NSString*, NSObject*>*)args andSource:(id<BatchUserActionSource>)source
{
    ...
    if (action)
    {
        ...
        {
            [BALogger debugForDomain:LOGGER_DOMAIN message:@"An action was found for '%@' but its action block was nil", identifier];
        }
    }
...
- (BOOL)publicPerformAction:(nonnull NSString*)identifier withArguments:(nonnull NSDictionary<NSString*, NSObject*>*)args
{
    ...
    if ([identifier stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]].length == 0)
    {
        [BALogger debugForDomain:LOGGER_DOMAIN message:@"Trying to manually perform an action from an empty identifier"];
        return NO;
    }
...
{
    return [BatchUserAction userActionWithIdentifier:[kBAActionsReservedIdentifierPrefix stringByAppendingString:@"deeplink"]
                                         actionBlock:^(NSString * _Nonnull identifier, NSDictionary<NSString *,NSObject*> * _Nonnull arguments, id<BatchUserActionSource> _Nullable source) {
                                             ...
                                             if ([linkArgument isKindOfClass:[NSString class]]) {
                                                 ...
                                                 [BALogger publicForDomain:LOGGER_DOMAIN message:@"An internal error occured while trying to perform a deeplink action. (Code 1)"];
                                             }
                                         }];
}
...
{
    return [BatchUserAction userActionWithIdentifier:[kBAActionsReservedIdentifierPrefix stringByAppendingString:@"refresh_lc"]
                                         actionBlock:^(NSString * _Nonnull identifier, NSDictionary<NSString *,NSObject*> * _Nonnull arguments, id<BatchUserActionSource> _Nullable source) {
...
{
    return [BatchUserAction userActionWithIdentifier:[kBAActionsReservedIdentifierPrefix stringByAppendingString:@"ios_request_notifications"]
                                         actionBlock:^(NSString * _Nonnull identifier, NSDictionary<NSString *,NSObject*> * _Nonnull arguments, id<BatchUserActionSource> _Nullable source) {
...
{
    return [BatchUserAction userActionWithIdentifier:[kBAActionsReservedIdentifierPrefix stringByAppendingString:@"ios_redirect_settings"]
                                         actionBlock:^(NSString * _Nonnull identifier, NSDictionary<NSString *,NSObject*> * _Nonnull arguments, id<BatchUserActionSource> _Nullable source) {
...
{
    return [BatchUserAction userActionWithIdentifier:[kBAActionsReservedIdentifierPrefix stringByAppendingString:@"ios_smart_reoptin"]
                                         actionBlock:^(NSString * _Nonnull identifier, NSDictionary<NSString *,NSObject*> * _Nonnull arguments, id<BatchUserActionSource> _Nullable source) {
...
{
    return [BatchUserAction userActionWithIdentifier:[kBAActionsReservedIdentifierPrefix stringByAppendingString:@"ios_tracking_consent"]
                                         actionBlock:^(NSString * _Nonnull identifier, NSDictionary<NSString *,id> * _Nonnull arguments, id<BatchUserActionSource>  _Nullable source) {
...
{
    return [BatchUserAction userActionWithIdentifier:[kBAActionsReservedIdentifierPrefix stringByAppendingString:@"clipboard"]
                                         actionBlock:^(NSString * _Nonnull identifier, NSDictionary<NSString *,NSObject*> * _Nonnull arguments, id<BatchUserActionSource> _Nullable source) {
                                             ...
                                             if ([text isKindOfClass:[NSString class]]) {
                                                 ...
                                                 [BALogger publicForDomain:LOGGER_DOMAIN message:@"An internal error occured while trying to perform a clipboard action. (Code 1)"];
                                             }
                                         }];
}
...
{
    return [BatchUserAction userActionWithIdentifier:[kBAActionsReservedIdentifierPrefix stringByAppendingString:@"rating"]
                                         actionBlock:^(NSString * _Nonnull identifier, NSDictionary<NSString *,NSObject*> * _Nonnull arguments, id<BatchUserActionSource> _Nullable source) {
...
- (void)performGroupAction:(nonnull NSDictionary<NSString *,NSObject*>*)rawArguments source:(nullable id<BatchUserActionSource>)source
{
    /*
     * Arguments look like:
     * {
    ...
    for (NSArray *rawAction in (NSArray*)rawActions) {
        ...
        if (![identifier isKindOfClass:[NSString class]]) {
            [BALogger debugForDomain:LOGGER_DOMAIN message:@"Could not parse group action item, identifier must be a string"];
            continue;
        }
        ...
        if ([rawAction count] > 1) {
            ...
            if (![args isKindOfClass:[NSDictionary class]]) {
                [BALogger debugForDomain:LOGGER_DOMAIN message:@"Could not parse group action item, arguments must be an object if present"];
                continue;
            }
        } else {
            args = @{};
