...
- (nullable NSData*)decrypt:(NSData*)rawData {
    ...
    NSData *cryptedData = [[NSData alloc] initWithBase64EncodedData:cryptedB64Data
                                                            options:0];
    if (cryptedData == nil) {
        // Invalid b64 data
        return nil;
    ...
    NSData *decryptedData = [self performCryptoOperation:kCCDecrypt
                                                  onData:cryptedData
                                              randomPart:dynamicKeyString];
...
- (nullable NSData*)performCryptoOperation:(CCOperation)operation
    ...
    [[_key stringByAppendingString:randomPart] getCString:cKeyPtr maxLength:sizeof(cKeyPtr) encoding:NSUTF8StringEncoding];
