...
/**
 ...
 This doesn't add the content hash. If you wish to sign your content, use -contentHashHeaderKey and -hashedContent: to
 append the hash to the headers. This method should be called once your headers are final.
 */
