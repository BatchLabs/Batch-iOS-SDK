                                  ...
                                  apiKey:(nonnull NSString *)apiKey
{
    if ([BANullHelper isStringEmpty:apiKey]) {
        [BALogger debugForDomain:@"WebserviceURLBuilder" message:@"Tried to call a webservice with a nil or empty API Key. Aborting."];
        return nil;
    }
    ...
    NSString *escapedAPIKey = [apiKey stringByAddingPercentEncodingWithAllowedCharacters:NSCharacterSet.URLPathAllowedCharacterSet];
