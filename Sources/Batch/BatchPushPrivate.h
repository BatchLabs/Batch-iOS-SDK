...
/**
 ...
 It will be sent to the server, to let Batch know whether a user enabled or disabled notifications globally in your app's settings.
 You can use it to implement your own "Notifications" setting toggle.
 ...
 If you have previously overriden the value to BatchPushNotificationSettingStatusDisabled, the property will not change.
 
 Note: This does NOT reflect the system settings. If the user opted out from iOS' settings, you will still get the original value you set previously here.
 You will need to handle this case in your settings, and redirect the user to the system settings.
 */
