...
+ (NSString*)makeUserAgent
{
    ...
    {
        pluginInfos = [NSString stringWithFormat:@"%@ ",[NSString stringWithCString:pluginVersion encoding:NSUTF8StringEncoding]];
    }
    ...
    {
        bridgeInfos = [NSString stringWithFormat:@"%@ ",[NSString stringWithCString:bridgeVersion encoding:NSUTF8StringEncoding]];
    }
    ...
    agent = [NSString stringWithFormat:@"%@%@%@/%@ %@/%@ (%@;iOS %@)",pluginInfos, bridgeInfos, BABundleIdentifier, BACoreCenter.sdkVersion, bundleID, appversion, device, osVersion];
