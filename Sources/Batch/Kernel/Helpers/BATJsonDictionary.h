...
/**
 ...
 If you allow a key to be nil/nonexistent, you'll have to check the error pointer to see if the value really was null or of the wrong kind.
...
/**
 ...
 While this may sound a little stupid, it allows for one line error bailing, rather than copy pasting the same tedious 3 lines
 */
