...
{
    [[BANotificationCenter defaultCenter] addObserver:observer selector:selector name:kBAReachabilityHelperNetworkStatusDidChangeNotification object:nil];
}

// Remove an observer from the observers list.
+ (void)removeObserver:(id)observer
{
    [[BANotificationCenter defaultCenter] removeObserver:observer name:kBAReachabilityHelperNetworkStatusDidChangeNotification object:nil];
}
...
- (void)startNotifierWithHostName:(NSString *)hostName
{
    @try
    {
        ...
        [[BANotificationCenter defaultCenter] addObserver:self selector:@selector(networkStatusDidChanged:) name:kBAReachabilityChangedNotification object:nil];
...
- (void)networkStatusDidChanged:(NSNotification *)notification
{
    ...
    @catch (NSException *exception)
    {
        NSLog(@"Error while posting reachability notification:%@, exception: %@", notification, [exception description]);
    }
}
