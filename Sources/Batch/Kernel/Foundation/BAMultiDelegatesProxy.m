...
- (NSMethodSignature *)methodSignatureForSelector:(SEL)selector
{
    ...
    [[NSException exceptionWithName:NSInternalInconsistencyException reason:[NSString stringWithFormat:@"Cannot find method signature for selector %@", NSStringFromSelector(selector)] userInfo:nil] raise];
