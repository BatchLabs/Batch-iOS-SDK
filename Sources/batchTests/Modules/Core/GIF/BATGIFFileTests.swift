...
struct BATGIFFileTests {
    ...
    func testImprovedDurationLogic() async throws {
        ...
        for testCase in testCases {
            ...
            if gifFile.frameCount > 0 {
                ...
                #expect(
                    abs(frame.duration - testCase.expected) <= tolerance,
    ...
    func testCreatedGIFFrameDurations() async throws {
        ...
        let expectedDurations: [TimeInterval] = [
            BATGIFFileTests.kBATGIFFrameDefaultDuration, BATGIFFileTests.kBATGIFFrameFallbackThreshold, BATGIFFileTests.kBATGIFFrameDefaultDuration, BATGIFFileTests.kBATGIFFrameDefaultDuration,
        ]
    ...
    func testFrameDurationProcessing() async throws {
        ...
        let testData = try #require(
            createTestGIFData(frameDurations: [0.01, BATGIFFileTests.kBATGIFFrameFallbackThreshold, BATGIFFileTests.kBATGIFFrameMinimumDuration]),
            "Could not create test GIF data"
        )
        ...
        for i in 0..<gifFile.frameCount {
            ...
            #expect(
                frame.duration >= BATGIFFileTests.kBATGIFFrameMinimumDuration,
