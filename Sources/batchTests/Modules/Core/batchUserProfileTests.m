...
- (void)setUp {
    ...
    OCMStub(ClassMethod([baParameterMock objectForKey:[OCMArg any] fallback:[OCMArg any]]))
        .andCall(mockedBaParameterImpl, @selector(objectForKey:fallback:));
    OCMStub(ClassMethod([baParameterMock setValue:[OCMArg any] forKey:[OCMArg any] saved:YES]))
        .andCall(mockedBaParameterImpl, @selector(setValue:forKey:saved:));
    OCMStub(ClassMethod([baParameterMock setValue:[OCMArg any] forKey:[OCMArg any] saved:NO]))
        .andCall(mockedBaParameterImpl, @selector(setValue:forKey:saved:));
    OCMStub(ClassMethod([(Class)baParameterMock removeObjectForKey:[OCMArg any]]))
        .andCall(mockedBaParameterImpl, @selector(removeObjectForKey:));
...
- (void)testVersion {
    ...
    XCTAssertGreaterThan([[internalProfile version] longLongValue], [firstVersion longLongValue],
                         @"Profile version should be greater than when we started");
}
