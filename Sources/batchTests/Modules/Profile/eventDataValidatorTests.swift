...
final class eventDataValidatorTests: XCTestCase {
    ...
    func testLabel() throws {
        ...
        expectEventValidationError(
            "$label: cannot be longer than 200 characters",
            attributes: BatchEventAttributes { a in
                a.put(longLabel, forKey: "$label")
            }
        )

        expectEventValidationError(
            "$label: cannot be empty or only made of whitespace",
            attributes: BatchEventAttributes { a in
                a.put("", forKey: "$label")
            }
        )
        ...
        expectEventValidationError(
            "$label: cannot be multiline",
            attributes: BatchEventAttributes { a in
                a.put("with_multi_\n_line", forKey: "$label")
            }
        )

        expectEventValidationSuccess(
            attributes: BatchEventAttributes { a in
    ...
    func testTagsAttribute() throws {
        expectEventValidationError(
            "$tags: must not contain more than 10 values",
            attributes: BatchEventAttributes { a in
        ...
        expectEventValidationError(
            "$tags[2]: tag cannot be empty or made of whitespace",
            attributes: BatchEventAttributes { a in
        ...
        expectEventValidationError(
            "$tags[1]: tag cannot be longer than 64 characters",
            attributes: BatchEventAttributes { a in
        ...
        expectEventValidationError(
            "$tags[2]: tag cannot be multiline",
            attributes: BatchEventAttributes { a in
    ...
    func testStringAttribute() throws {
        expectEventValidationSuccess(
            attributes: BatchEventAttributes { a in
                a.put(String(repeating: "not_too_long", count: 25), forKey: "string_attr")
            }
        )

        expectEventValidationError(
            "string_attr: string attribute cannot be longer than 300 characters",
            attributes: BatchEventAttributes { a in
        ...
        expectEventValidationError(
            "string_attr: string attribute cannot be empty or made of whitespace",
            attributes: BatchEventAttributes { a in
        ...
        expectEventValidationError(
            "string_attr: string attribute cannot be multiline",
            attributes: BatchEventAttributes { a in
    ...
    func testURLAttribute() throws {
        expectEventValidationError(
            "url_attr: URL attributes cannot be longer than 2048 characters",
            attributes: BatchEventAttributes { a in
    ...
    func testObjectAttribute() throws {
        let errors = BATEventAttributesValidator(
        ...
        expectEventValidationError(
            "<attributes root>: objects cannot hold more than 20 attributes",
            attributes: BatchEventAttributes { a in
                for i in 0...20 {
    ...
    func testStringArrayAttribute() throws {
        ...
        expectEventValidationError(
            "string_array_attr[1]: string attribute cannot be multiline",
            attributes: BatchEventAttributes { a in
        ...
        expectEventValidationError(
            "list_attr: array attributes cannot have more than 25 elements",
            attributes: BatchEventAttributes { a in
        ...
        expectEventValidationSuccess(
            attributes: BatchEventAttributes { a in
                a.put(["a", "b", "c", String(repeating: "not_too_long", count: 25)], forKey: "string_array_attr")
            }
        )
    }
