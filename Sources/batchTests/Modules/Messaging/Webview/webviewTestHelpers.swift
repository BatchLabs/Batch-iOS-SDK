...
class MinimalWebviewJavascriptBridge: BATWebviewJavascriptBridge {
    ...
    override func executeMethod(_ method: String?, arguments rawJSONArguments: [AnyHashable : Any]?) -> BAPromise<NSString> {
        switch method {
            case "success":
                return BAPromise.resolved("ok")
            case "failure":
                return BAPromise.rejected(NSError(domain: "tests", code: 0, userInfo: [NSLocalizedDescriptionKey: expectedErrorMessage]))
            case "echo":
