...
#pragma clang diagnostic pop
    ...
    message = [[BAPushPayload alloc] initWithUserInfo:@{
        kWebserviceKeyPushBatchData : @{@"i" : @"CAMPAIGN", kWebserviceKeyPushDeeplink : @"non-url deeplink"}
    }];
    ...
    message = [[BAPushPayload alloc] initWithUserInfo:@{
        kWebserviceKeyPushBatchData : @{@"i" : @"CAMPAIGN", kWebserviceKeyPushDeeplink : @"https://batch.com"}
    }];
    XCTAssertNotNil(message, @"Unable to create a message with a valid identifier.");
