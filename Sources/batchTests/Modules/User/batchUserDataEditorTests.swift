...
class UserDataEditorTests: XCTestCase {
    ...
    func testModernAttributeMethodErrors() {
        ...
        for key in invalidKeys {
            ...
            assertThrowsError(
                code: .invalidKey,
                try editor.setAttribute(Date(timeIntervalSince1970: 12345), forKey: key)
            )
    ...
    func assertThrowsError(
        code: BAInstallDataEditorError.Code,
        _ expression: @escaping @autoclosure () throws -> Void,
