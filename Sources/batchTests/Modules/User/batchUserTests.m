...
- (void)setUp {
    ...
    BAUserSQLiteDatasource *dataSourceToUse = [[BAUserSQLiteDatasource alloc] initWithDatabaseName:@"test-attribute-read"];
...
- (void)testCustomDataLimits {
    ...
    // Set values
    [_editor setRegion:@"a"];
    [_editor setRegion:@"01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"];
    [_editor setLanguage:@"a"];
    [_editor setLanguage:@"01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"];
    [_editor setIdentifier:@""];
