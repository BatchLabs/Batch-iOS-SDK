...
@interface builtinActionsTest : XCTestCase @end
...
- (void)testTagEditAction {
    ...
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"t": @"foo", @"a": @"add"} andSource:nil];
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"t": @"foo", @"a": @"remove"} andSource:nil];
    
    // Bad values
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{} andSource:nil];
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"t": @"foo", @"a": @"nothing"} andSource:nil];
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"t": @"foo", @"a": [NSNull null]} andSource:nil];
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"t": @"foo", @"a": @(20)} andSource:nil];
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"t": @"foo"} andSource:nil];
    
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"t": @"", @"a": @"add"} andSource:nil];
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"t": [NSNull null], @"a": @"add"} andSource:nil];
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"t": @(20), @"a": @"add"} andSource:nil];
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @"bar", @"a": @"add"} andSource:nil];
    
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": [NSNull null], @"t": @"foo", @"a": @"add"} andSource:nil];
    [[BAActionsCenter instance] performAction:@"batch.user.tag" withArgs:@{@"c": @(20), @"t": @"foo", @"a": @"add"} andSource:nil];
...
- (void)testTrackEventAction {
    ...
    OCMExpect([batchUserMock trackEvent:@"test_event" withLabel:@"test_label" associatedData:[OCMArg checkWithBlock:^BOOL(id parameter) {
    ...
    [[BAActionsCenter instance] performAction:@"batch.user.event" withArgs:@{@"e": @"test_event", @"l": @"test_label"} andSource:nil];
    
    
    OCMExpect([batchUserMock trackEvent:@"test_event_2" withLabel:@"test_label_2" associatedData:[OCMArg checkWithBlock:^BOOL(id parameter) {
        ...
        return [data->_tags count] == 3 && [data->_tags containsObject:@"tag1"] && [data->_tags containsObject:@"tag2"] && [data->_tags containsObject:@"tag3"];
    }]]);
    [[BAActionsCenter instance] performAction:@"batch.user.event" withArgs:@{@"e": @"test_event_2", @"l": @"test_label_2", @"t": @[@"tag1", @"tag2", @"tag3"]} andSource:nil];
    
    
    OCMExpect([batchUserMock trackEvent:@"test_event_3" withLabel:@"test_label_3" associatedData:[OCMArg checkWithBlock:^BOOL(id parameter) {
    ...
    [[BAActionsCenter instance] performAction:@"batch.user.event" withArgs:@{@"e": @"test_event_3", @"l": @"test_label_3", @"a": @{@"bool": @YES, @"int": @64, @"double": @654.21, @"string": @"toto", @"date": @"2020-08-09T12:12:23.943Z"}} andSource:nil];
