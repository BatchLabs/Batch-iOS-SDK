...
class batchContextTests: XCTestCase {
    ...
    func testUserAttributeContext() {
        ...
        XCTAssertEqual(resolve("c.date"), BALPrimitiveValue(double: 1_536_325_808_234))
...
@objc fileprivate class BaseMockCustomDataDatasource: NSObject, BAUserDatasourceProtocol {
