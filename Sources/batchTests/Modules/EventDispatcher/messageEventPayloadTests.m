...
- (void)testPushMessageEventPayload {
    NSDictionary<NSString *, NSObject *> *dictionary = @{
        ...
        @"body" : @"TEST",
        @"ed" : @{@"t" : @"l", @"v" : @"0", @"lth" : @"SIMPLE-TOP-BANNER", @"i" : @"1569579362154"},
        @"kind" : @"banner",
        ...
        @"auto_close" : @10000,
        @"style" : @"@import "
                   @"sdk(\"banner1\");\n*{--valign:top;--countdown-color:#191E5E;--countdown-valign:bottom;--ios-"
                   @"shadow:15 0.5 "
                   @"#000000;--android-shadow:10;--title-color:#DB243B;--body-color:#666666;--bg-color:#FFFFFF;--close-"
                   @"color:#666666;--cta-android-shadow:auto;--cta1-color:#DB243B;--cta1-text-color:#FFFFFF;--cta2-"
                   @"color:#ffffff;--cta2-text-color:#E3959F;--margin:15;--corner-radius:5;--mode:dark;}",
        @"cta" : @[
            @{
                @"a" : @"batch.deeplink",
                @"args" : @{@"l" : @"https://batch.com/test?utm_campaign=test&utm_content=main_button"},
                @"l" : @"TEST"
            },
            @{
                @"a" : @"batch.deeplink",
                @"args" : @{@"l" : @"https://batch.com/test?utm_campaign=test&utm_content=second_button"},
                @"l" : @"TEST"
            },
            @{
                @"args" : @{
    ...
    action1.actionArguments = @{@"l" : @"https://batch.com/test?utm_campaign=test&utm_content=main_button"};
