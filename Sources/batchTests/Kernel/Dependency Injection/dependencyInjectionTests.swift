...
class dependencyInjectionTests : XCTestCase {
    ...
    func testInstanceInjection() throws {
        ...
        let injectedProtocol = try XCTUnwrap(registry.inject(protocol: injectionTestProtocol.self) as? injectionTestProtocol)
    ...
    func testInstanceBlockInjection() throws {
        ...
        var injectedClass = try XCTUnwrap(registry.inject(class: injectionOffsetableTestClass.self) as? injectionOffsetableTestClass)
        var injectedProtocol = try XCTUnwrap(registry.inject(protocol: injectionTestProtocol.self) as? injectionTestProtocol)
        ...
        injectedClass = try XCTUnwrap(registry.inject(class: injectionOffsetableTestClass.self) as? injectionOffsetableTestClass)
        injectedProtocol = try XCTUnwrap(registry.inject(protocol: injectionTestProtocol.self) as? injectionTestProtocol)
    ...
    func testOverlays() throws {
        ...
        func refreshInjections() throws {
            injectedClass = try XCTUnwrap(registry.inject(class: injectionOffsetableTestClass.self) as? injectionOffsetableTestClass)
            injectedProtocol = try XCTUnwrap(registry.inject(protocol: injectionTestProtocol.self) as? injectionTestProtocol)
            injectedUntouchedClass = try XCTUnwrap(registry.inject(class: injectionTestClass.self) as? injectionTestClass)
        }
