...
- (void)testBasics {
    ...
    XCTAssertEqualObjects([BAParameter objectForKey:@"not-exist-key" fallback:@"not-exist-value"], @"not-exist-value",
                          @"No value must be found for key 'not-exist-key'.");
...
- (void)testOthers {
    ...
    // Check results.
    XCTAssertNotEqual([BAParameter objectForKey:@"fake-bool-key" fallback:@"-"], @"-",
                      @"No value found for the boolean value.");
    XCTAssertNotEqual([BAParameter objectForKey:@"fake-number-key" fallback:@"-"], @"-",
                      @"No value found for the number value.");
    XCTAssertNotEqual([BAParameter objectForKey:@"fake-float-key" fallback:@"-"], @"-",
                      @"No value found for the float value.");
    XCTAssertNotEqual([BAParameter objectForKey:@"fake-array-key" fallback:@"-"], @"-",
                      @"No value found for the array value.");
    XCTAssertNotEqual([BAParameter objectForKey:@"fake-dic-key" fallback:@"-"], @"-",
                      @"No value found for the dictionary value.");
}
...
- (void)testStorage {
    ...
    XCTAssertNotEqual([BAParameter objectForKey:@"fake-super-key" fallback:@"-"], @"-",
                      @"No value found for the stored value.");
}
