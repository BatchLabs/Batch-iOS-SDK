 ...
 * @param actionBlock The action block that will be invoked when Batch wants to execute your action. Can be called from any thread
...
/*!
 @enum BatchActionError
 @abstract BatchActions error code constants.
 */
enum
{
    /*!
